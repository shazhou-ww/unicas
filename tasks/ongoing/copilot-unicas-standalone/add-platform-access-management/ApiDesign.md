...
Support the platform workflows in [ConsoleMock.html](/tasks/ongoing/copilot-unicas-standalone/add-platform-access-management/ConsoleMock.html) and
[UiDesign.md](/tasks/ongoing/copilot-unicas-standalone/add-platform-access-management/UiDesign.md) without treating Google authentication, OAuth
...
[PlatformAccess.openapi.json](/tasks/ongoing/copilot-unicas-standalone/add-platform-access-management/PlatformAccess.openapi.json) is the executable
proposal contract; [ApiReference.html](/tasks/ongoing/copilot-unicas-standalone/add-platform-access-management/ApiReference.html) renders that file
