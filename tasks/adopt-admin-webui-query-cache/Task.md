...
- [Related Console navigation task](/tasks/simplify-console-administration-navigation/Task.md)
- [Related administrator identity task](/tasks/support-multi-provider-admin-identity/Task.md)
