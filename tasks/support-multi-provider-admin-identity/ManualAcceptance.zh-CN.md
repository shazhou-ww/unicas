...
> 备注
>
> - 管理员 A：现有 Google OIDC 身份
> - 测试账号 B：未绑定的 Microsoft 个人账号
> - B 的关联身份：还需分别准备未绑定的 Google OIDC 和 GitHub OAuth 身份
> - 冲突账号 C：未绑定的 GitHub OAuth 身份，其已验证邮箱与测试邮箱 E 相同
> - 测试邮箱 E：由验收人员控制，且未加入 Cloudflare 预验证收件人列表
> - 实际邮箱映射只保存在验收人员的本地记录中，不写入仓库
