...
- [Platform access API discussion](/tasks/ongoing/copilot-unicas-standalone/add-platform-access-management/ApiDesign.md)
- [Console UI discussion](/tasks/ongoing/copilot-unicas-standalone/add-platform-access-management/UiDesign.md)
