...
| OpenAPI | [`tenant-v1.openapi.json`](../../../../packages/tenant-protocol/openapi/tenant-v1.openapi.json), [`admin-v1.openapi.json`](../../../../packages/admin-protocol/openapi/admin-v1.openapi.json) | Generated v1 artifacts | Keep v1 artifacts frozen and generate separately named v2 artifacts. |
...
- Control resources and operations are owned by
  ...
  [`service/src/control-admin.ts`](../../../../packages/service/src/control-admin.ts).
